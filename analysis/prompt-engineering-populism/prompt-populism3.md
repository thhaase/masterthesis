...
1. **People Attitude (The Ingroup)**
    ...
    - "The People" must imply the **universal ordinary majority.** This can be explicit (e.g., "The common people," "The citizens," "We the people") or implicit (e.g., speaking from a collective "we/our" perspective, framing shared ordinary experience against powerful interests).
