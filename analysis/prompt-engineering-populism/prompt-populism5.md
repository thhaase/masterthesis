...
1. **People Attitude (The Ingroup)**
    ...
    - "The People" must imply the **universal ordinary majority.** This can be explicit (e.g., "The common people," "The citizens," "We the people") or implicit (e.g., speaking from a collective "we/our" perspective, framing shared ordinary experience).
...
2. **People signal:** Does the text invoke a broad ordinary majority — explicitly (e.g., "we," "the citizens," "the people") or implicitly (e.g., collective "our," shared grievance, speaking as/for ordinary experience)? _Am I inferring "The People" just because an elite is attacked? But also: am I dismissing an implicit people-reference because no keyword is present? If the text names a specific subgroup rather than "The People" as a whole: does the text frame this subgroup as representing the ordinary majority's experience, or is it advocating for that group's particular interests?_
...
Score each dimension on its own textual evidence. A finding on one dimension should not raise or lower your score on another.
