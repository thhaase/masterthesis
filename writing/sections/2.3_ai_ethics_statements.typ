// === AI STATEMENT ===
#align(center)[
  #heading(outlined: false, level: 2)[Generative AI Statement]
]
...
#v(2cm)
#align(center)[
  #heading(outlined: false, level: 2)[Ethics Statement]
]
//#text(fill: red)[what is probelmatic???]
/*
- Twitter
  - Data gathered through the official Twitter API for researchers in 2022. The platform therefore was not harmed whatsoever
- Data safety
  - Stored on Laptop, never uploaded in any cloud other than TU Dresdens secure Datashare
  - Textanalysis done at TU Dresden Capella Cluster with a local LLM, the data therefore never leaves either MPI Leipzig, TU Dresden or my Laptop
- Individuals
  - No Individual Usernames are part of the analysis, the users are only relevant as a piece constructing a   group.
- Politicians 
  - Politicians names can be used since they are part of a public political discourse whose mechanics are of interest of the general public represented by those politicians.  
  - The public interest in the politicians posting behaviors and the public discourse around it is defended by Article 40 of the Digital Service Act of the European Union (European Parliament and Council 2022). This justifies the analysis not only on a moral but also legal ground.
*/
